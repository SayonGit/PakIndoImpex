...
/**
 * PLACEHOLDER CONTENT — see home.testimonials.items in src/messages/en.json.
 * These are illustrative, anonymized example quotes for reviewing the
 * section's design, not real client testimonials. Per assets/CONTENT.md's
 * anti-fabrication rules, replace every item with a verified, real buyer
 * quote (with their consent) before this section goes live for visitors.
 */
      ...
      <Container>
        ...
        >
          ...
          <div key={index} className="animate-fade-up mt-6 text-center">
            <p className="text-xl leading-relaxed font-medium text-ink-900 sm:text-2xl">
